...
import Badge from "../../../../../components/tk-ui/Badge";
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto bg-white rounded-lg shadow-md">
      ...
      <p className="text-gray-600 mb-6 text-lg">
        Badge bileşeni, genellikle bir UI elementinin yanında ekstra bilgi
        vermek için kullanılan bir arayüz öğesidir. Aktiflik, bildirim sayısını
        belirtme, uyarı vb. durumları belirtmek için kullanılabilir. Kullanıcı
