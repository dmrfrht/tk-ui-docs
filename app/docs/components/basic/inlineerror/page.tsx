  ...
  return (
    <div className="p-6 max-w-3xl mx-auto bg-white rounded-lg shadow-md">
      ...
      <div className="bg-gray-100 p-4 rounded-lg">
        <CopyBlock
          text={`<InlineError type="error">Bir hata oluştu</InlineError>`}
          language="jsx"
          showLineNumbers
          theme={dracula}
          wrapLines
        ...
        {[
          {
            ...
            code: `<InlineError type="error">Bir hata oluştu</InlineError>`,
            inlineErrorClass: "flex items-start gap-[6px] mt-2",
